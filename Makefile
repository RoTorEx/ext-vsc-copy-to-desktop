.PHONY: install deps-update build watch typecheck lint fmt test check run release release-tag release-push release-publish vibe-kernel-set vibe-kernel-path vibe-pull vibe pull
